...
public class HomeViewModel extends ViewModel implements IWebUtilities {
    ...
    void updateNews(boolean targeting) {

        updateNews(currentGroup.getIdInst(), targeting);
    }

    private void updateNews(int group, boolean targeting){
    ...
    private void updateNews(int group){
    ...
    void preLoadNews(MainActivity activity, boolean targeting){

        updateNews(activity.readGroup(), targeting);
    }
}